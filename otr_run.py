...
def discover_features() -> Dict[str, Tuple[str, str]]:
    """
...
def pytest_sessionfinish(session: Any, exitstatus: Any) -> None:
    ...
    for component, profiles_run in sorted(
        ...
        OTRReporter.render_dashboard(
            component, list(profiles_run), list_milestones=list_milestones
        )
...
def main() -> None:
    ...
    """
    FEATURES: Dict[str, Tuple[str, str]] = discover_features()
    ...
    if feature in ["a", "all"]:
        test_targets = ["tests/"]
        print("\nRunning benchmarks for all features...")
    else:
